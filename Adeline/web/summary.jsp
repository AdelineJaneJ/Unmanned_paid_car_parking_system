...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                   ...
                   <h3  style=" color: #32C2CD; text-align:center; font-size:30px;  margin-top:20px; font-weight: bolder">BALANCE: RS.1000</h3>
                     <br>
                         <br>
                    <style>
      table{
   ...
   <table align="center" border="1" style="width: 90% !important; margin-left:50px;line-height: 1.7;border-radius: 12px;text-align:center;color: black;text-transform: capitalize;">
	            ...
	            <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from booking where user='"+user+"' ");
	            ...
	            %>
	            			<tr>
                                            <td style=" color: black;"><%=rs.getString("user") %></td>       
                                                <td style=" color: black;"><%=rs.getString("slot") %></td>
	            				<td style=" color: black;"><%=rs.getString("date") %></td>
                                                <td style=" color: black;"><%=rs.getString("amount") %></td>
                                                <td style=" color: black;"><%=rs.getString("status") %></td>
