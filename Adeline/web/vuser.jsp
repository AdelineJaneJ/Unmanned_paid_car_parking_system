...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                 ...
                 <h2  style=" text-align:center; font-size:40px;  margin-top:10px; font-weight: bolder">Booking Details</h2>
   ...
   <table align="center" border="1" style="width: 90% !important; margin-left:50px;line-height: 1.7;border-radius: 12px;text-align:center;color: black;text-transform: capitalize;">
	            ...
	            <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from booking  ");
