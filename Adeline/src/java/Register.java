...
public class Register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try 
		{
		    ...
		    PreparedStatement query=con.prepareStatement("insert into reg(user,lname,pass,email,date,gender,blood,car,tn,mobile,location,image)values ('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+m.get(6)+"','"+m.get(7)+"','"+m.get(8)+"','"+m.get(9)+"','"+m.get(10)+"','"+ms.get(0)+"')");
