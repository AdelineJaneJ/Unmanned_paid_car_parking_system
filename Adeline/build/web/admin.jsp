        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <style>
                 ...
                 <h2  style=" text-align:center; font-size:30px;  margin-top:150px; font-weight: bolder">Admin Login</h2>
                 <form action="aloginc.jsp">
                     <table align="center">
                     <tr><td><strong>Username: </strong></td><td><input type="text" name="user" style="  " required></td></tr>
                     <tr><td><strong>Password: </strong></td><td><input type="password" name="pass"  style="   " required></td></tr>
                     <tr><td align="center" colspan="2"><button type="submit" style="  font-size: 15px; background-color: #32C2CD; ">LOGIN</button> </td></tr>
                    </table>
                     </form>
